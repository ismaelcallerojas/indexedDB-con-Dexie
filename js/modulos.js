...
const bulkcreate = (dbtable, data) => {
  ...
  if (flag) {
    ...
    console.log("Por favor proporcione datos...!");
  }
  return flag;
};
...
// revisar validacion de las cajas de texto
const empty = object => {
  let flag = false;
...
const SortObj = (sortobj) => {
  ...
  obj = {
    ...
    Vendedor: sortobj.Vendedor,
    Precio: sortobj.Precio,
